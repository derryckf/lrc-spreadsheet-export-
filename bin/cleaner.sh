...
sed 's/Sue,Kerr,/Susan,Kerr,/g'|\
sed 's/Job,\"Siope Tai\",/Jobe,Tai,/g'|\
sed 's/Lenne,Evans,/Leanne,Evans,/g'|\
sed 's/Nigel,Freeston,/Nigel,Freestone,/g'|\
sed 's/Tony,Darsarklis,/Tony,Darsaklis,/g'|\
sed 's/Natlie,Slocombe,/Natalie,Slocombe,/g'|\
sed 's/Nataile,Slocombe,/Natalie,Slocombe,/g'|\
sed 's/Haydn,Bevis,/Haydyn,Bevis,/g'|\
sed 's/Robert,Miller,/Rob,Miller,/g'|\
sed 's/Keith,CameronSmith,/Keith,Cameron-Smith,/g'|\
sed 's/Deon,Birtwhistle,/Deon,Birtwistle,/g'|\
sed 's/Archie,Rogers,/Archer,Rogers,/gi'|\
sed 's/Darsakalis,/Darsaklis,/g'|\
sed 's/,Dee,"anne Blackwell",/,"Dee anne",Blackwell,/gi'|\
sed "s/,Damon,Sherrif,/,Damon,Sherriff,/gi"|\
sed "s/,Liz,Staak,/,Elizabeth,Staak,/gi"|\
sed "s/,Michael,Howard,/,Mick,Howard,/gi"|\
sed "s/,Debra,Pauna,/,Debbie,Pauna,/gi"|\
...
sed 's/Phoebe,JacksonMills,/Phoebe,Jackson-Mills,/gi'|\
...
sed "s/,Debbie,ORegan,/,Debra,O\'Regan,/gi"|\
sed "s/,Shaun,ORegan,/,Shaun,O\'Regan,/gi"|\
...
sed 's/,Gabby,Heger,/,Gabrielle,Heger,/gi'|\
sed 's/,Liv,Gooley,/,Olivia,Gooley,/gi'|\
sed 's/,Neill,Daly,/,Neil,Daly,/gi'|\
sed 's/,Oliver,Manion,/,Oliver,Mannion,/gi'|\
sed 's/,Stephen,Fitzallen,/,Steve,Fitzallen,/gi'|\
sed 's/Joe,\"Rogers Senior\",/Joseph,Rogers-Snr,/g'|\
sed 's/,Joe,Rogers,/,Joseph,Rogers-Snr,/gi'|\
sed 's/,Joe,Rogers Jnr,/,Joseph,Rogers-Jnr,/gi'|\
sed 's/Joe,"Rogers Snr",/Joseph,Rogers-Snr,/gi'|\
sed 's/Joe,"Rogers Jnr",/Joseph,Rogers-Jnr,/gi'|\
...
sed 's/,Scott,Greaves,1967-10-09,/,Scott,Greaves,1967-10-08,/gi'|\
sed 's/,Scott,Greaves,1967-10-10,/,Scott,Greaves,1967-10-08,/gi'|\
sed 's/,Tim,Reese,1978-10-05,/,Timothy,Reese,1978-12-05,/gi'|\
sed 's/,Tim,Reese,/,Timothy,Reese,/gi'|\
sed 's/,Josh,Slocombe,/,Joshua,Slocombe,/gi'|\
sed 's/,Leigh,Evans,1969-02-11,Female,/,Leigh,Evans,1969-02-11,Male,/gi'|\
sed 's/,\(Charlie,Reese,[^,]*\),2008-10-05,/,\1,2008-12-05,/g'|\
sed 's/,\(Scott,Greaves,[^,]*\),1967-10-09,/,\1,1967-10-08,/g'|\
sed 's/,\(Scott,Greaves,[^,]*\),1967-10-10,/,\1,1967-10-08,/g'|\
sed 's/,\(Barry,Sproston,[^,]*\),1981-08-08,/,\1,1980-09-08,/g'|\
sed 's/,\(Barry,Sproston,[^,]*\),1980-08-08,/,\1,1980-09-08,/g'|\
sed 's/,\(Paige,Wierenga,[^,]*\),1994-09-16,/,\1,1994-11-17,/g'|\
sed 's/,\(Deb,George,[^,]*\),1964-01-15,/,\1,1964-04-15,/g'|\
sed 's/,\(Michelle,Barnard,[^,]*\),1970-07-25,/,\1,1970-08-25,/g'|\
